...
{
    public class UnitOfWork<BankDatabaseContext> : IUnitOfWork<BankDatabaseContext>, IDisposable
         where BankDatabaseContext : DbContext, new()
    {
        ...
        public UnitOfWork()
        {
            _context = new BankDatabaseContext();
        }
        ...
        public BankDatabaseContext Context
        {
            get { return _context; }
        }
